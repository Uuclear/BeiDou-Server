...
/**
 * GM0（所有玩家可用）命令：将属性点分配到智力
 */
public class StatIntCommand extends Command {
    {
        setDescription(I18nUtil.getMessage("StatIntCommand.message1"));
    }
    ...
    public void execute(Client c, String[] params) {
        ...
        if (params.length > 0) {
            ...
            amount = Math.min(remainingAp, GameConfig.getServerInt("max_ap") - player.getInt());
        }
