...
*/
package org.gms.net.server.coordinator.matchchecker.listener;
...
import org.gms.net.server.coordinator.matchchecker.AbstractMatchCheckerListener;
import org.gms.net.server.coordinator.matchchecker.MatchCheckerListenerRecipe;
    ...
    public AbstractMatchCheckerListener getListener() {
        return new AbstractMatchCheckerListener() {
            ...
            public void onMatchAccepted(int leaderid, Set<Character> matchPlayers, String message) {
                ...
                leader.gainMeso(-GameConfig.getServerInt("create_guild_cost"), true, false, true);
