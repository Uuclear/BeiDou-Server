 ...
 * 经验值表常量类
 * <p>
 * 存储游戏中各种升级所需经验值的常量数据，包括：
 * <ul>
 *   <li>角色等级升级经验表（1-200级）</li>
 *   <li>装备等级升级经验表</li>
 *   <li>宠物亲密度升级表</li>
 *   <li>坐骑经验升级表</li>
 * </ul>
 * </p>
 *
 * @author OdinMS Team (Patrick Huy, Matthias Butz, Jan Christian Meyer)
 * @since 1.0.0
 */
public final class ExpTable {

    /**
     * 角色升级所需经验值表（索引0未使用，索引1-200对应1-200级）
     */
     ...
     * 获取指定等级升级所需的经验值
     *
     * @param level 目标等级（1-200）
     * @return 升级所需经验值，超过200级返回2000000000
     */
